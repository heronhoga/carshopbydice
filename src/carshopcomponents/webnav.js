...
import "../carshopcomponents/AboutUsBanner.js";
import "../carshopcomponents/carListsBanner.js";
import "../carshopcomponents/SparepartsBanner.js";
  ...
  return (
    <div>
      <nav className="navigation">
        <h3 className="brand">DICECARSHOP</h3>
        <button
          className="hamburger"
          onClick={() => {
        ...
        <div className={isNavExpanded ? "navigation-menu expanded" : "navigation-menu"}>
          <ul>
            <li>
              <a href="/honme" className="ref">
                HOME
              </a>
            </li>
            <li>
              <a href="#aboutUs" className="ref">
                ABOUT
              </a>
            </li>
            <li>
              <a href="#carLists" className="ref">
                CAR LISTS
              </a>
            </li>
            <li>
              <a href="#spareParts" className="ref">
                SPAREPARTS
              </a>
            </li>
          </ul>
